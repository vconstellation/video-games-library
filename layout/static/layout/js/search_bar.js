...
//     $.getJSON(endpoint, request_parameters).done()
//     })
// }
...
input.addEventListener('keyup', () => {
    ...
    //     scheduled_function = setTimeout(ajax_search, delay_by_in_ms, endpoint, request_parameters)
    }
})
